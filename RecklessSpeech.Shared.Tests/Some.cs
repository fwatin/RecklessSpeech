...
public static class Some
{
    ...
    public const string SomeAudiofileNameWithExtension = "1658501397855.mp3";
    
    public const string SomeTags = "\"word-naked lang-nl netflix Green pron \"";

    public const string SomeSequenceContent =
        "\"<style>a lot of things in html\"	[sound:1658501397855.mp3]	\"word-naked lang-nl netflix Green pron \"";
    public static Guid EventId => Guid.Parse("771AE7D9-9923-4AFD-B1CE-9A851C660203");
}