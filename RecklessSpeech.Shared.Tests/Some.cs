...
{
    //todo mettre le word en {}
    public const string SomeRealCaseCsvFileContentForGimmicksInMoneyBall =
        "\"<style>\n\n    html,\n    body {\n        padding: 0;\n        margin: 0;\n    }\n\n    .card {\n        " +
        ...
        "\"	[sound:1658501397855.mp3]	\"word-naked lang-nl netflix Green pron \"";
}